...
class m180227_024757_create_auth_log_table extends Migration
{
    ...
    public function up()
    {
        $this->createTable('auth_log', [
            'id' => $this->primaryKey(),
            'changer_id' => $this->integer()->defaultValue(null),
            'changeable_id' => $this->integer()->notNull(),
            'new_role_name' => $this->string()->notNull(),
        ...
        $this->addForeignKey('auth_log_new_role_name', 'auth_log', 'new_role_name', 'auth_item', 'name');
        ...
        $this->createIndex('auth_log_new_role_name_index', 'auth_log', 'new_role_name');
    }
    ...
    {
        $this->dropIndex('auth_log_new_role_name_index', 'auth_log');
        $this->dropIndex('auth_log_changeable_id_index', 'auth_log');
        $this->dropIndex('auth_log_changer_id_index', 'auth_log');

        $this->dropForeignKey('auth_log_new_role_name', 'auth_log');
